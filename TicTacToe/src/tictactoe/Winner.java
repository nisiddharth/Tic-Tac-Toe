...
public class Winner extends javax.swing.JFrame {
    ...
    String name;
    int sr1,sr2;
    public Winner(String n1,int sc1,int sc2) {
        name=n1;
        sr1=sc1;
        sr2=sc2;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText(name+ " has won the game!!! Score: "+sr1+"/"+sr2);

        jLabel3.setBackground(new java.awt.Color(22, 0, 32));
        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 204));
        jLabel3.setText("What to do next?");
     ...
     * @param pn
     */
    public static void main(String pn,int sc1,int sc2) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Winner(pn,sc1,sc2).setVisible(true);
        });
    }
